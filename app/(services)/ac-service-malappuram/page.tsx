...
export const metadata: Metadata = constructMetadata({
  title: "AC Service in Malappuram - Expert Repair & Gas Charging",
  description: "Get the best AC service in Malappuram. Professional gas charging, filter cleaning, and repair solutions. Fast response and certified experts.",
  canonical: "https://servicebooking.com/ac-service-malappuram"
});
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full text-primary text-sm font-bold">
                ...
                AC Experts in Malappuram
              </div>
              
              <h1 className="text-5xl md:text-6xl font-headline font-extrabold text-on-surface leading-tight">
                Professional <span className="text-primary">AC Repair</span> & Service
              </h1>
              
              <p className="text-lg text-on-surface-variant leading-relaxed max-w-xl">
                Is your AC not cooling? Our expert technicians in Malappuram provide 
                comprehensive repair, gas charging, and maintenance for all brands.
              </p>
