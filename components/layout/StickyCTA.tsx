...
export const StickyCTA = () => {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 w-full bg-surface/90 backdrop-blur-md z-50 p-4 pb-safe flex justify-around items-center border-t border-outline-variant/10 shadow-[0_-4px_20px_0_rgba(0,0,0,0.05)] rounded-t-3xl">
      <Link href="tel:+918590203732" className="flex flex-col items-center justify-center text-on-surface-variant py-2 px-6 active:scale-95 transition-transform">
      ...
      <Link href="https://wa.me/918590203732" className="flex flex-col items-center justify-center bg-primary text-on-primary rounded-2xl py-2 px-8 active:scale-95 transition-transform">
